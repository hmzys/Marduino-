...
void sceneCredit() {
  ...
  while (gamestate == GAME_CREDITS) {
    ...
    if (TIMER_CURRENT - TIMER_PREV > DELAY) {
      ...
      if (page < 2)
        display.print("YAPANLAR:");
      display.setCursor(0, 8);
      if (page == 0) {
        display.println("BUNU YAPANLAR:");
        display.println("Tobias Ulrich ve Reginaldo  da Silva.");
      } else if (page == 1) {
        display.println("C uzerinden vearduino uno ile birlikte yap.");
        sizex = 10 * 6;
